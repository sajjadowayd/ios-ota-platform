      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="text-sm text-gray-500 hover:text-gray-800 px-4 py-2 rounded-xl border border-gray-200 hover:border-gray-300 transition-colors"
          >
            Logout
          </button>
        </div>
            ...
            {apps.map((app) => (
              <li key={app.id} className="flex items-center gap-4 px-6 py-4">
                <div className="relative w-12 h-12 flex-shrink-0">
                  <Image
                    src={getIconUrl(app.iconFilename)}
                    alt={app.name}
                    fill
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500">
                    v{app.version} &middot; {app.bundleId} &middot;{' '}
